...
/**
 * <b>Main characteristic of {@link UndoStack2} is that two different stacks should not share one subject.</b>
 ...
 */
public class UndoStack2 implements Serializable{
    ...
    private List<UndoCommand2> commands;
    private List<UndoCommand2> macroStack;
     ...
     * @param group possible group for this {@link UndoStack2}.
     */
    public UndoStack2(@NotNull Object subj, UndoGroup2 group) {
        this.subj = subj;
        if(null != group) {
            group.add(this);
        }
     ...
     */
    public void push(@NotNull UndoCommand2 cmd) {
        ...
        UndoCommand2 cur = null;
        UndoCommand2 macroCmd = null;
        if(macro) {
    ...
    public void beginMacro(String caption) {
        ...
        final UndoCommand2 cmd = new UndoCommand2(this, caption, null);
     ...
     */
    public UndoCommand2 getCommand(int idx) {
